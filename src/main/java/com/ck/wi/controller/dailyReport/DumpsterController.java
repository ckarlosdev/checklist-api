...
public class DumpsterController {
    ...
    public List<DumpsterDto> getDumpstersByDailyReportId(@PathVariable Integer dailyReportId){
        List<Dumpster> dumpsters = dumpsterService.findByDailyReportId(dailyReportId);
